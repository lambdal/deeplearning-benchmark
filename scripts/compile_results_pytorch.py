...
list_test = {
             ...
             # 'PyTorch_tacotron2_FP32': ('PyTorch_tacotron2_FP32 (samples/sec)', "^.*Training throughput:.*$", -1),
             # 'PyTorch_tacotron2_FP16': ('PyTorch_tacotron2_FP16 (samples/sec)', "^.*Training throughput:.*$", -1),
             # 'PyTorch_waveglow_FP32': ('PyTorch_waveglow_FP32 (samples/sec)', "^.*Training throughput:.*$", -1),
             # 'PyTorch_waveglow_FP16': ('PyTorch_waveglow_FP16 (samples/sec)', "^.*Training throughput:.*$", -1),
