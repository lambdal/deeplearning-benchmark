...
list_system_single = {
    'V100': ([0, 1], 'V100 32GB', '250'),
    'QuadroRTX8000': ([0, 1], 'RTX 8000', '260'),
    'QuadroRTX6000': ([0, 1], 'RTX 6000', '260'),
    'QuadroRTX5000': ([0, 1], 'RTX 5000', '230'),
    'TitanRTX': ([0, 1], 'Titan RTX', '280'),
    '2080Ti': ([0, 1], 'RTX 2080Ti', '250'),
    '1080Ti': ([0, 1], 'GTX 1080Ti', '250'),
    '2080SuperMaxQ': ([0, 1], 'RTX 2080 SUPER MAX-Q', '80'),
    '2080MaxQ': ([0, 1], 'RTX 2080 MAX-Q', '90'), 
    '2070MaxQ': ([0, 1], 'RTX 2070 MAX-Q', '90'),
    '3070': ([1, 1], 'RTX 3070', '220'),
    '3080': ([1, 1], 'RTX 3080', '320'),
    '3090': ([1, 1], 'RTX 3090', '350'),
    'A100_PCIe': ([1, 1], 'A100 40GB PCIe', '250'),
    'A100_SXM4': ([1, 1], 'A100 40GB SXM4', '400'),
    'A6000': ([1, 1], 'RTX A6000', '300'),
    'A5000': ([1, 1], 'RTX A5000', '230'),
    'LambdaCloud_A6000': ([1, 1], 'Lambda Cloud — RTX A6000', '300'),
    '3080Max-Q': ([1, 1], 'RTX 3080 Max-Q', '80'),
    'A40': ([1, 1], 'RTX A40', '300'),
    'A4000': ([1, 1], 'RTX A4000', '140'),
    # 'A100_p4': [1, 1]
    }

list_system_multiple = {
    '2x2080TiNVlink_trt': ([0, 2], '2x RTX 2080Ti NVLink', '500'),
    # '2x2080TiNVlink_trt2': [0, 2],
    '2x2080Ti_trt': ([0, 2], '2x RTX 2080Ti', '500'),
    # '2x2080Ti_trt2': [0, 2],
    '4x2080TiNVlink_trt': ([0, 4], '4x RTX 2080Ti NVLink', '1000'),
    # '4x2080TiNVlink_trt2': [0, 4],
    '4x2080Ti_trt': ([0, 4], '4x RTX 2080Ti', '1000'),
    # '4x2080Ti_trt2': [0, 4],
    '8x2080TiNVlink_trt': ([0, 8], '8x RTX 2080Ti NVLink', '2000'),
    # '8x2080TiNVlink_trt2': [0, 8],
    '8x2080Ti_trt': ([0, 8], '8x RTX 2080Ti', '2000'),
    # '8x2080Ti_trt2': [0, 8],    
    # '2xQuadroRTX8000NVlink_trt': [0, 2],
    '2xQuadroRTX8000NVlink_trt2': ([0, 2], '2x RTX 8000 NVLink', '520'),
    # '2xQuadroRTX8000_trt': [0, 2],
    '2xQuadroRTX8000_trt2': ([0, 2], '2x RTX 8000', '520'),
    # '4xQuadroRTX8000NVlink_trt': [0, 4],
    '4xQuadroRTX8000NVlink_trt2': ([0, 4], '4x RTX 8000 NVLink', '1040'),
    # '4xQuadroRTX8000_trt': [0, 4],
    '4xQuadroRTX8000_trt2': ([0, 4], '4x RTX 8000', '1040'),
    # '8xQuadroRTX8000NVlink_trt': [0, 8],
    '8xQuadroRTX8000NVlink_trt2': ([0, 8], '8x RTX 8000 NVLink', '2080'),
    # '8xQuadroRTX8000_trt': [0, 8],
    '8xQuadroRTX8000_trt2': ([0, 8], '8x RTX 8000', '2080'),
    '2xV100': ([0, 2], '2x V100 32GB', '500'),
    '4xV100': ([0, 4], '4x V100 32GB', '1000'),
    '8xV100': ([0, 8], '8x V100 32GB', '2000'),
    'LambdaCloud_4x1080Ti': ([0, 4], 'Lambda Cloud — 4x GTX 1080Ti', '1000'),
    'LambdaCloud_2xQuadroRTX6000': ([0, 2], 'Lambda Cloud — 2x RTX 6000', '520'),
    'LambdaCloud_4xQuadroRTX6000': ([0, 4], 'Lambda Cloud — 4x RTX 6000', '1040'),
    'LambdaCloud_8xV10016G': ([0, 8], 'Lambda Cloud — 8x V100 16GB', '2400'),
    'Linode_2xQuadroRTX6000': ([0, 2], 'Linode Cloud — 2x RTX 6000', '520'),
    'p3.16xlarge': ([0, 8], 'p3.16xlarge', '2400'),
    'p3.8xlarge': ([0, 4], 'p3.8xlarge', '1200'),
    '2x3070': ([1, 2], '2x RTX 3070', '440'),
    '2x3080': ([1, 2], '2x RTX 3080', '640'),
    '2x3090': ([1, 2], '2x RTX 3090', '700'),
    '3x3090': ([1, 3], '3x RTX 3090', '1050'),
    '4x3070': ([1, 4], '4x RTX 3070', '880'),
    '4x3090': ([1, 4], '4x RTX 3090', '1400'),
    '8x3070': ([1, 8], '8x RTX 3070', '1760'),
    '8x3090': ([1, 8], '8x RTX 3090', '2800'),
    '2xA100_PCIe': ([1, 2], '2x A100 40GB PCIe', '500'),
    '4xA100_PCIe': ([1, 4], '4x A100 40GB PCIe', '1000'),
    '8xA100_PCIe': ([1, 8], '8x A100 40GB PCIe', '2000'),
    '2xA100_SXM4': ([1, 2], '2x A100 40GB SXM4', '800'),
    '4xA100_SXM4': ([1, 4], '4x A100 40GB SXM4', '1600'),
    '8xA100_SXM4': ([1, 8], '8x A100 40GB SXM4', '3200'),
    '8xA6000': ([1, 8], '8x RTX A6000', '2400'),
    '4xA6000': ([1, 4], '4x RTX A6000', '1200'),
    '2xA6000': ([1, 2], '2x RTX A6000', '600'),
    '4xA5000': ([1, 4], '4x RTX A5000', '920'),
    '2xA5000': ([1, 2], '2x RTX A5000', '460'),
    '8xA100_p4': ([1, 8], 'p4d.24xlarge', '3200'),
    'LambdaCloud_2xA6000': ([1, 2], 'Lambda Cloud — 2x RTX A6000', '600'),
    'LambdaCloud_4xA6000': ([1, 4], 'Lambda Cloud — 4x RTX A6000', '1200'),
    '8xA40': ([1, 8], '8x RTX A40', '2400'),
    '4xA40': ([1, 4], '4x RTX A40', '1200'),
    '2xA40': ([1, 2], '2x RTX A40', '600'),
    '8xA4000': ([1, 8], '8x RTX A4000', '1120'),
    '4xA4000': ([1, 4], '4x RTX A4000', '560'),
    '2xA4000': ([1, 2], '2x RTX A4000', '280'),
    # '2xA100_p4': [1, 2],
    # '4xA100_p4': [1, 4],
}
...
def gather_last(list_test, list_system, name, system, config_name, df, version, path_result):
    ...
    df.at[config_name, 'watt'] = list_system[system][2]
