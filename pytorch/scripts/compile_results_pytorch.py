...
list_system_single = {
    ...
    "DellTexas_H100_80GB_SXM5_v1": ([1, 1], "DellTexas H100 80GB SXM5", 700, 36718.75),
...
list_system_multiple = {
    ...
    "DellTexas_2xH100_80GB_SXM5_v1": ([1, 2], "DellTexas 2x H100 80GB SXM5", 700, 36718.75),
    ...
    "DellTexas_4xH100_80GB_SXM5_v1": ([1, 4], "DellTexas 4x H100 80GB SXM5", 700, 36718.75),
    ...
    "DellTexas_8xH100_80GB_SXM5_v1": ([1, 8], "DellTexas 8x H100 80GB SXM5", 700, 36718.75),
