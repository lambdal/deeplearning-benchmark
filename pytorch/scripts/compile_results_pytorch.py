...
list_system_single = {
    ...
    'A100_80GB_PCIe_v1': ([1, 1], 'A100 80GB PCIe', 300, 15143),
...
list_system_multiple = {
    ...
    '2xA100_80GB_PCIe_v1': ([1, 2], '2xA100 80GB PCIe', 300, 15143),
    '2xA100_80GB_SXM4_v1': ([1, 2], '2xA100 80GB SXM4', 400, 18571),
    ...
    '4xA100_80GB_SXM4_v1': ([1, 4], '4xA100 80GB SXM4', 400, 18571),
    ...
    '8xA100_80GB_SXM4_v1': ([1, 8], '8xA100 80GB SXM4', 400, 18571),
