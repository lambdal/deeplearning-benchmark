...
TF_VERSION="$(python -c "import tensorflow; print(tensorflow.__version__)" | awk '{ print $NF }')"

RESULTS_PATH=/results/${SYSTEM}
mkdir -p $RESULTS_PATH

SYSTEM_FILE=${RESULTS_PATH}/sys_tensorflow.txt
...
echo "TensorFlow Version: "${TF_VERSION} >> $SYSTEM_FILE
